 ...
 *     description: |
 *       Generates educational content using Anthropic (claude-3-5-sonnet-20241022).
 *
 *       **Format behaviour:**
 ...
 *       - `image` — Anthropic generates a descriptive prompt, which is passed to Pollinations.ai. Returns an image URL.
